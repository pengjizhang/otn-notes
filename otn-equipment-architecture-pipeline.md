...
```mermaid
flowchart LR
    G1["<b>WDM 时代</b><br/>（线路技术）<br/><br/>点到点大容量传输<br/>受限于电再生器成本<br/>缺乏组网与管理开销"]
    G2["<b>经典 OTN 时代</b><br/>（G.709 数字封装）<br/><br/>光波集装箱概念<br/>OPU/ODU/OTU 三层封装<br/>电交叉与波分协同管理"]
    G3["<b>POTN/MOTN 时代</b><br/>（分组与 5G 优化）<br/><br/>L0/L1 光传送 + L2 分组交换<br/>单级复用与 1μs 超低时延<br/>5G 硬切片与软切片"]
    G4["<b>超100G / SDON 时代</b><br/>（软件定义全光网）<br/><br/>Flex OTN / FlexO / OTUCn<br/>32维 Flex-Grid ROADM<br/>SDON 集中控制 / 全光网 AON"]
...
| 软件层级 | 模块名称 | 核心职责与关键技术 |
| :--- | :--- | :--- |
| **应用层** | **管控软件 (Feature OS)** | 运行于主控板，负责业务开通配置、ASON 自动路由与故障自愈、50ms APS 保护倒换及 NETCONF/YANG 北向网管接入 |
