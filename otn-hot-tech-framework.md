...
> \* Liquid OTN、PeOTN、POTN 三者本质相同——一张网同时承载硬管道和软管道，统一调度。POTN 是通用概念，PeOTN 是联通的运营商版本，Liquid OTN 是华为的产品品牌。详见[第 8 节](#8-第五层光电融合与多业务统一承载)。
...
> **三者关系**：POTN（Packet Optical Transport Network）是通用概念，指在同一设备内同时做 L0 光层、L1 ODUk 电层、L2 Packet 三层交换。PeOTN（Packet enhanced OTN）是中国联通对 POTN 的运营商落地版本，强调 OTN 为主、分组为辅。Liquid OTN 是华为对自家 ODUk + OSU + Packet 融合方案的产品品牌。三个名词指向同一件事——让一张网同时承载硬管道和软管道，不再各自建网。
